...
public class JdbcPrestoIT extends TestSuiteBase implements TestResource {
    ...
    private static final String DOCKER_IMAGE = "prestodb/presto";
    private static final String DRIVER_CLASS = "io.presto.jdbc.prestoDriver";
    private static final String HOST = "e2e_presto";
    private static final String URL = "jdbc:presto://%s:8080";
