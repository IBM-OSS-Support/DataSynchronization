      ...
      <NSpace vertical>
        <NCard>
          {{
            ...
            'header-extra': () => <NSpace>
              <cv-button aria-label="button story" default="sm" size="sm" onClick={testConnect} loading={status.testing}>
              {t('datasource.test_connect')}
              </cv-button>
              <cv-button aria-label="button story" kind="secondary" default="Secondary" size="sm" onClick={onClose}>
              {t('datasource.cancel')}
              </cv-button>
              <cv-button aria-label="button story" kind="secondary" default="Secondary" size="sm" onClick={createOrUpdate} loading={status.saving}>
            ...
            <NGrid xGap={10}>
              ...
              >
                ...
                >
                  ...
                  {!route.params.id && (
                    <cv-button onClick={() => void (showSourceModal.value = true)} aria-label="button story" kind="secondary" default="Secondary" size="sm">
                      {t('datasource.select')}
                    </cv-button>
                    // <NButton
                    //   text
