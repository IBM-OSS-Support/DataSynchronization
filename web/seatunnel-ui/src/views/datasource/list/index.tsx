          ...
          {{
            'header-extra': () => (
              <NSpace>
                ...
                <cv-search
                 clearable
                 v-model={[this.searchVal, null]}
                 modelValue={null}
                 placeholder={'Search with datasource name'}
                 size="sm"
                >
                </cv-search>
                <cv-button onClick={this.handleSearch} aria-label="button story" kind="secondary" default="Secondary" size="sm">
                {this.t('datasource.search')}
                </cv-button>
                <cv-button onClick={onCreate} aria-label="button story" default="sm" size="sm">
                {this.t('datasource.create')}
                </cv-button>
