        ...
        <NSpace vertical>
          ...
          >
            ...
            <span 
              ...
              title={'Drag Source into Canvas and Double Click on it to Setup Configurations'}
            >
              &#9432; {/* Info Icon Circle Unicode */}
            </span>
          </div>
          <div
            class={styles['task-item']}
          ...
          >
            ...
            <span 
              class="ml-auto inline-block"
              title={'Drag Sink into Canvas and Double Click on it to Setup Configurations'}
            >
              &#9432; {/* Info Icon Circle Unicode */}
            </span>
          </div>
            ...
            this.transforms.map((t: any) => {
              ...
              return (
                <div>
                    ...
                    <span 
                      class="ml-auto inline-block"
                      title={'Drag '+ item.name +' into Canvas and Double Click on it to Setup Configurations'}
                    >
                      &#9432; {/* Info Icon Circle Unicode */}
                    </span>
