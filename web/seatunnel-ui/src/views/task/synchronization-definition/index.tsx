      ...
      <NSpace vertical>
        <NCard>
          <NSpace justify='space-between' itemStyle={{ flexGrow: 1 }}>
            <cv-button onClick={this.handleModalChange} aria-label="button story" default="sm" size="sm">
            {this.t(
            ...
            <NSpace justify='end'>
              ...
              <cv-search
              clearable
              v-model={[this.searchName, null]}
              modelValue={null}
              placeholder={'Search With ' + this.t(
                'project.synchronization_definition.task_name'
              )}
              size="sm"
              onKeyup={this.handleKeyup}
              ...
              <cv-button onClick={this.onSearch} aria-label="button story" kind="secondary" default="Secondary" size="sm">
                Search
              </cv-button>
            </NSpace>
          </NSpace>
        ...
        <NCard>
          <NSpace vertical>
            <NDataTable
              ...
              data={this.tableData}
            />
            <NSpace justify='center' class='pagination'>
              {/* <NPagination
