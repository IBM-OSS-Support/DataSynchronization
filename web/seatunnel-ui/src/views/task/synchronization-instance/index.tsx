    ...
    return (
      <NSpace vertical>
        ...
        <cv-content-switcher selected="onSelected">
          <cv-content-switcher-button owner-id="csb-1" selected="selectedIndex === 0">{this.t('project.synchronization_instance.offline_sync')}</cv-content-switcher-button>
          <cv-content-switcher-button owner-id="csb-2" >{this.t('project.synchronization_instance.real_time_sync')}</cv-content-switcher-button>
        </cv-content-switcher>
